...
When starting anything interesting I suddenly find focus and with that inspiration, so I put them in articles *(the one's clearly not written yet hehe)*, and "wrote away." It's a terrifically fulfilling yet agonizing process to write so detailed and think of its connection to a different topic, and then write away on that one. Did you know that our brain uses brainpower even when seated as when doing physical exercise? I can't quote where that's from until I write an article about it *(I probs will anyhow)*, otherwise I believe it- since it makes sense.

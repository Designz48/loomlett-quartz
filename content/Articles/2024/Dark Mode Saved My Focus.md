...
![](https://miro.medium.com/v2/resize:fit:700/0*mFWmr0lgVk3_S2zW.jpeg)

Image by [Sora Shimazaki](https://www.pexels.com/@sora-shimazaki/) from [Pexels](https://www.pexels.com/photo/crop-hacker-typing-on-laptop-with-information-on-screen-5935787/)
...
I didn’t realize my need until a few years of studying later, when just this month I started using [Obsidian](https://obsidian.md/).
...
A large part of its fame is because of aesthetics, especially in having contrast & legibility, but only if you have an [OLED display](https://blog.superhuman.com/why-do-people-use-dark-mode/).
...
- Reduce screen headaches (not backed up with [evidence](https://blog.superhuman.com/why-do-people-use-dark-mode/))
- Helps focus and concentratio —

Wait, let’s look at that last one.

The whole point of this article is how dark mode _saved my focus_, right?

Well, remember that guru who told you that only dark-mode should be used and white-mode kills your eyes… not true.

Dark-mode (conducted by [studies](https://saasjet.com/blog/dark-mode-vs-light-mode/)) only helped some participants focus better when working, whereas, most actually preferred white-mode when concentrating.

That’s right, **_white-mode promotes concentration._**

This is [due to](https://saasjet.com/blog/dark-mode-vs-light-mode/):
...
**_Focus is crucial when it comes to our environment._**

During the daytime, depending on how long we’ve been accustomed to sunlight, [dark mode makes the eyes work harder since they need to absorb more light.](https://www.myeyedr.com/rx-optical-now-part-myeyedr)
...
A very fancy scientific article on [UX Movement](http://uxmovement.com/content/when-to-use-white-text-on-a-dark-background/) states, “white stimulates all three types of color sensitive visual receptors in the human eye in nearly equal amounts.”
...
> _“ People with astigmatism (approximately 50% of the population) find it harder to read white text on black than black text on white. Part of this has to do with light levels: with a bright display (white background) the iris closes a bit more, decreasing the effect of the “deformed” lens; with a dark display (black background) the iris opens to receive more light and the deformation of the lens creates a much fuzzier focus at the eye, ” article on_ [_UX Movement_](http://uxmovement.com/content/when-to-use-white-text-on-a-dark-background/)_._
...
**_So using dark mode in_** [**_Notion_**](https://www.notion.so/) **_can help!_**
...
A Free Notion template to add your to-do’s and focus points for that night **_easily & without hassle._**

Use it for your workflow, along with other freebies, on my [**_website_**](https://designzbyoj.lemonsqueezy.com/)!

**Tip: next time you’re in your settings, think _night for night_ & _light for light._**
